...
# Check each position in grid for word
...
def solve_puzzle(grid, words):
    ...
    # Score words by rarity of letters (less frequent = higher score)
    ...
    # Sort words by rarity score (highest first)
...
def solve_all_puzzles():
    ...
    method_name = "frequency_heuristic.py"
    total_time = 0
